...
Please note CATALYST and diffcyt are not our tools. 
...
Get the Docker image and start a JupyterLab server. This docker image includes both a python and an R kernel, both intended to be run through jupyter notebooks on the JupyterLab server.  
  
The following is an example on Linux, running the JupyterLab server as yourself:  
...
### [00 - Python -  Stage Example Data](/documentation/00_PreparingFCS.md)
...
### [01 - R - Get Panel Details](/documentation/01_GetPanelDetails.md)
...
### [02 - Python - Create metadata template](/documentation/02_CreateMetaDataTemplate.md)
...
### [03 - Python - Ingest filled-in metadata](/documentation/03_IngestFilledMetaData.md)

Take the completed metadata spreadsheet and ingest it, creating a validated JSON format of all the input data.

### [04 -R - Run CATALYST Stage 1](/documentation/04_RunCATALYSTstage1.md)

Use the metadata JSON you created to run CATALYST for the first stage of the pipeline and over-clustering.  
  
This step includes quality control plots.  

### [05 - Python - Generate Cluster template](/documentation/05_GenerateClusterTemplate.md)

Take the CATALYST outputs and produce an Excel worksheet of unlabeled clusters and generate figures.

### [06 - Python - Ingest labeled clusters](/documentation/06_IngestLabeledClusters.md)

Using python, ingest the Excel spreadsheet with cluster labels and save it as a JSON.

### [07 - R - Run CATALYST stage 2](/documentation/07_RunCATALYSTstage2.md)
...
### [08 - Python - Output Data](/documentation/08_OutputData.md)

Save primary per-cell data and cell-type frequency, cell-type expression, and pseudobulk expression data, using python. 

### [09 - R - diffcyt](/documentation/09_diffcyt.md)
